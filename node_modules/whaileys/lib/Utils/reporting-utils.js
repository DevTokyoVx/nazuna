...
exports.getMessageReportingToken = exports.generateMsgSecretKey = exports.shouldIncludeReportingToken = void 0;
...
exports.generateMsgSecretKey = generateMsgSecretKey;
const getMessageReportingToken = async (msgProtobuf, message, key) => {
    ...
    const reportingSecret = await (0, exports.generateMsgSecretKey)(ENC_SECRET_REPORT_TOKEN, key.id, from, to, msgSecret);
