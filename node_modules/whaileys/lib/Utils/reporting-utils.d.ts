...
export declare const generateMsgSecretKey: (modificationType: string, origMsgId: string, origMsgSender: string, modificationSender: string, origMsgSecret: Uint8Array) => Promise<Buffer>;
