...
const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, useUserDevicesCache, statusJidList }) => {
        ...
        const destinationUser = (_b = (0, WABinary_1.jidDecode)(destinationJid)) === null || _b === void 0 ? void 0 : _b.user;
        const isDestinationPn = (0, WABinary_1.isJidUser)(destinationJid);
        const participants = [];
        ...
        await authState.keys.transaction(async () => {
            ...
            if (isGroupOrStatus && !isRetryResend) {
                ...
                const meLidUser = (_b = (0, WABinary_1.jidDecode)(meLid)) === null || _b === void 0 ? void 0 : _b.user;
                const isPeerMsg = user === meUser || user === meLidUser;
                if ((additionalAttributes === null || additionalAttributes === void 0 ? void 0 : additionalAttributes["category"]) === "peer" && isPeerMsg) {
                    devices.push({ user });
                }
                else {
                ...
                if (isLidMode && isDestinationPn) {
                    const destinationLid = devices.length &&
                        ((_c = devices.find(d => d.user === destinationUser)) === null || _c === void 0 ? void 0 : _c.lid);
                    if (destinationLid) {
                        destinationJid = (0, WABinary_1.jidEncode)(destinationLid, "lid");
                        additionalAttributes = {
                            ...additionalAttributes,
                            peer_recipient_pn: (0, WABinary_1.jidNormalizedUser)(jid)
                        };
                    }
                }
                ...
                for (const { user, lid, device } of devices) {
                    ...
                    const encodedLid = (0, WABinary_1.jidEncode)(userId, isLidMode ? "lid" : "s.whatsapp.net", device);
                    if (isMe) {
            ...
            if (isRetryResend) {
                ...
                const isMe = (0, WABinary_1.areJidsSameUser)(participant.jid, meId) ||
                    (0, WABinary_1.areJidsSameUser)(participant.jid, meLid);
                if ((0, WABinary_1.isJidUser)(participant.jid)) {
            ...
            const contactTcTokenData = !isGroup && !isRetryResend && !isStatus
                ...
                : {};
            const tcTokenBuffer = (_f = contactTcTokenData[destinationJid]) === null || _f === void 0 ? void 0 : _f.token;
            if (tcTokenBuffer) {
                stanza.content.push({
                    tag: "tctoken",
                    attrs: {},
            ...
            const innerMessage = ((_g = message.documentWithCaptionMessage) === null || _g === void 0 ? void 0 : _g.message) || message;
            ...
            if (!isRetryResend &&
                ...
                ((_h = message.messageContextInfo) === null || _h === void 0 ? void 0 : _h.messageSecret)) {
                const reportingKey = {
                    id: msgId,
                    fromMe: true,
