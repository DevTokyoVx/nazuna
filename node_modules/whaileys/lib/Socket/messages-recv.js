        ...
        try {
            ...
            await Promise.all([
                processingMutex.mutex(async () => {
                    ...
                    (0, process_message_1.cleanMessage)(msg, authState.creds.me.id, (_a = authState.creds.me) === null || _a === void 0 ? void 0 : _a.lid);
                    const content = (0, Utils_1.normalizeMessageContent)(msg.message);
                    const secretEncryptedMessage = content === null || content === void 0 ? void 0 : content.secretEncryptedMessage;
                    const secretEncType = secretEncryptedMessage === null || secretEncryptedMessage === void 0 ? void 0 : secretEncryptedMessage.secretEncType;
                    if (secretEncryptedMessage &&
                        secretEncType !== null &&
                        secretEncType !== undefined &&
                        secretEncType !==
                            WAProto_1.proto.Message.SecretEncryptedMessage.SecretEncType.UNKNOWN) {
                        const targetMessageKey = secretEncryptedMessage.targetMessageKey;
                        const originalMessage = (targetMessageKey === null || targetMessageKey === void 0 ? void 0 : targetMessageKey.id)
                            ...
                            : undefined;
                        const messageSecret = (_c = (_b = (0, Utils_1.normalizeMessageContent)(originalMessage)) === null || _b === void 0 ? void 0 : _b.messageContextInfo) === null || _c === void 0 ? void 0 : _c.messageSecret;
                        if (messageSecret === null || messageSecret === void 0 ? void 0 : messageSecret.length) {
                            await (0, process_message_1.decryptSecretEncryptedMessage)(msg, messageSecret, authState.creds.me.id, (_d = authState.creds.me) === null || _d === void 0 ? void 0 : _d.lid, logger);
                        }
                        else {
    ...
    const handleBadAck = async ({ attrs }) => {
        ...
        if (attrs.error === "475" && !(0, WABinary_1.isJidGroup)(attrs.from)) {
            ...
            if (shouldResendMessageOn475AckError) {
                ...
                const msg = (await (sentMessagesCache === null || sentMessagesCache === void 0 ? void 0 : sentMessagesCache.get(key.id))) || (await getMessage(key, "bad-ack"));
                if (msg) {
